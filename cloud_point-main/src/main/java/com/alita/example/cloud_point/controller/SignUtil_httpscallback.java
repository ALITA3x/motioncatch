...
public class SignUtil_httpscallback {
    ...
    public static void main(String[] args) throws IOException {
        ...
        Map<String, Object> params = new HashMap<>();
            ...
            //params.put("cmd", "DEVICE_EVENT");
            params.put("uids", uids);
            params.put("event", 4);
            //params.put("eventName","用户1离开房间");
            params.put("params", "{\"entry2Exit\":\"1\"}"); // Fix: Added double quotes and escaped inner quotes
            params.put("url", "https://743c580d-34ca-4308-a9f4-ca7ba36f95f6.mock.pstmn.io");
