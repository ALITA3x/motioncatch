...
public class SignUtil_syncPupillus {
    ...
    public static void main(String[] args) throws IOException {
        ...
        params.put("eqtName", "marson");
        params.put("oldManName", "marson");
        params.put("age",28);
        params.put("gender",1);
        params.put("medicineState",0);
        params.put("medicalDiagnosis",0);
        params.put("walkingAid",0);
        params.put("gait",0);
        params.put("cognize",0);
        //params.put("date","19450223");
        //params.put("event", 1);
